...
class testerrrController extends Controller
{
    //
...
//   number two not colored
                ...
                if (str_starts_with(trim($kid1), 'P-')) {
                    $text .= '<p   align="center"; ><img width=100% height=auto src="assets/images/' . $kid1 . '.png" ></p>';
                    // if (strchr($kid1, 'C')) {
                    //     $text .= '<p   align="center"; ><img width="200px" height="120px" src="assets/images/' . $kid1 . '.png" ></p>';
                    // }
                    // if (strchr($kid1, 'R')) {
                    //     $text .= '<p align="right" ><img width="146px" height="47px" src="assets/images/' . $kid1 . '.png" ></p>';
                    // }
                ...
                if (!str_starts_with(trim($kid1), 'P') && !str_starts_with(trim($kid1), 'G')) {
                    ...
                    if (str_starts_with(trim($kid1), 'RB')) {
                        ...
                        if ($color) {
                            ...
                            $text .= $kid1;
                            $text .= " position: absolute"."font-size:" . ($size/1.5) . "px;font-family:" . $Font . ";'>" . $value . "\n";
                    ...
                    if (str_starts_with(trim($kid1), 'TB')) {
                        ...
                        $text .= "<div class='Title_Box' style='font-size:" . ($size/1.5) . " "."px;'>";
